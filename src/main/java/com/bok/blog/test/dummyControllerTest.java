...
//html이아니라 data를 리턴해주는 controller
@RestController
public class dummyControllerTest {
	...
	public User detail(@PathVariable int id) {
		// user/4를 찾으면 내가 데이터베이스에서 못찾아오게 되면 user 가 null이 될 것 아냐?
		// 그럼 return null 이 리턴이 되잖아.. 그럼 프로그램에 문제가 있지 않게신?
		...
		//스프링부트 = Message converter라는 애가 응답시에 자동 작동
